...
public class InventoryDaoImpl implements InventoryDao {
    ...
    private final String INSERTPROSESINVENTORY = "INSERT INTO prosesinventorybarangbesar(user, tanggal, jam, kode, nama, harga, ekspedisi, jumlah, subharga) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    
    private final String DELETEPROSESINVENTORY = "DELETE FROM prosesinventorybarangbesar WHERE id = ?";
    
    private final String TRUNCATEPROSESINVENTORY = "TRUNCATE TABLE prosesinventorybarangbesar";
