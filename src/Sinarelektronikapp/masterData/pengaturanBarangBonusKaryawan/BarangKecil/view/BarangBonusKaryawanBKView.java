 ...
 * @author Fauzi
 */
public class BarangBonusKaryawanBKView extends javax.swing.JPanel implements BarangBonusKaryawanBKListener, ListSelectionListener{
    ...
    public BarangBonusKaryawanBKView() throws SQLException, BarangBonusKaryawanBKException {
    ...
    private void btCari1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCari1ActionPerformed
        /*try {
            // TODO add your handling code here:
            new BarangController().cariBarangBonusKaryawan(this, this);
    ...
    private void cmbUrut1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbUrut1ActionPerformed
        /*try {
            new BarangController().sortBarangBonusKaryawan(this);
        } catch (SQLException ex) {
            Logger.getLogger(BarangBonusKaryawanBKView.class.getName()).log(Level.SEVERE, null, ex);
        } catch (BarangException ex) {
            Logger.getLogger(BarangBonusKaryawanBKView.class.getName()).log(Level.SEVERE, null, ex);
