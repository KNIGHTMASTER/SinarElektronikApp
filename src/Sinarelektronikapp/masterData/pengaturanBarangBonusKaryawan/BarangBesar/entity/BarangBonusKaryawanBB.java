 ...
 */
package Sinarelektronikapp.masterData.pengaturanBarangBonusKaryawan.BarangBesar.entity;
 ...
 * @author FAUZI
 */
public class BarangBonusKaryawanBB {

    public BarangBonusKaryawanBB() {
    }
    
    private String kodeBarang, nama, tipe, merek;

    public BarangBonusKaryawanBB(String kodeBarang, String nama, String tipe, String merek) {
    ...
    public boolean equals(Object obj) {
        ...
        final BarangBonusKaryawanBB other = (BarangBonusKaryawanBB) obj;
