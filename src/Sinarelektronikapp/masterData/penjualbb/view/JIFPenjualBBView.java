 ...
 * @author Fauzi
 */
public class JIFPenjualBBView extends javax.swing.JInternalFrame implements tipeListener, ListSelectionListener{
    ...
    public JIFPenjualBBView() {
        try {
            ...
            Logger.getLogger(JIFPenjualBBView.class.getName()).log(Level.SEVERE, null, ex);
