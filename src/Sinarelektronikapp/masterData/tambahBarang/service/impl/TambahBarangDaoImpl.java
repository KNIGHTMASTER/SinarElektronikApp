...
public class TambahBarangDaoImpl implements TambahBarangDao{
    ...
    final String insertBarang = "INSERT INTO barang (idbarang, idbarcode, namabarang, tipe, merek, hargamodal, grosir, eceran, satuan, stok, stok_minimum, supplier, keterangan, gambar, garansi, lamagaransi, kategori) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public void insertBarang(barang barang) throws TambahBarangException {
        ...
        try{
            ...
            statement.setString(17, barang.getKategori());
