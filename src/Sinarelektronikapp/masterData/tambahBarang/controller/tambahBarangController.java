 ...
 */
package Sinarelektronikapp.masterData.tambahBarang.controller;
...
import Sinarelektronikapp.masterData.tambahBarang.view.tambahBarangView;
import java.io.File;
...
public class tambahBarangController {
    ...
    public void insertBarang(tambahBarangView view){
        ...
        if(namaBarang.trim().equals("")){
            ...
            JOptionPane.showMessageDialog(view, "barang berhasil dimasukkan");
        }
    }    
}
