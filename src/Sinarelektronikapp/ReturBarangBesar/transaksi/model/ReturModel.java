 ...
 */
package Sinarelektronikapp.ReturBarangBesar.transaksi.model;

import Sinarelektronikapp.ReturBarangBesar.transaksi.database.ReturDatabase;
...
public class ReturModel {
    ...
    String user, jam, kode, nama, tanggal;
