...
public class InventoryDaoImpl implements InventoryDao {
    ...
    private final String INSERTPROSESINVENTORY = "INSERT INTO prosesinventory.barangbesar(user, tanggal, jam, kode, nama, harga, ekspedisi, jumlah, subharga) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    
    private final String DELETEPROSESINVENTORY = "DELETE FROM prosesinventory.barangbesar WHERE id = ?";
    
    private final String TRUNCATEPROSESINVENTORY = "TRUNCATE TABLE prosesinventory.barangbesar";
