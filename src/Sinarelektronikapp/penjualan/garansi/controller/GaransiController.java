 ...
 */
package Sinarelektronikapp.penjualan.garansi.controller;

import Sinarelektronikapp.penjualan.garansi.model.GaransiModel;
import Sinarelektronikapp.penjualan.garansi.view.GaransiView;
...
public class GaransiController {
    ...
    public void insertGaransi(GaransiView view){
        ...
        if(idGaransi.trim().equals("")){
            ...
            JOptionPane.showMessageDialog(view, "jumlah barang masih kosong");
            return;                        
        }else if(masaAkhir.trim().equals("")){
            JOptionPane.showMessageDialog(view, "masa akhir barang masih kosong");
            return;                                    
