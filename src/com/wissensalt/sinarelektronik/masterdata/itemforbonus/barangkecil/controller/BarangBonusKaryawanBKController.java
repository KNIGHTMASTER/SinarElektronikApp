...
package com.wissensalt.sinarelektronik.masterdata.itemforbonus.barangkecil.controller;
...
public class BarangBonusKaryawanBKController {
    ...
    public void resetTipe(JIFBarangKecilBonusKaryawanBKView view){
        model.resetTipe();
    }
    
    public void insertTipe(JIFBarangKecilBonusKaryawanBKView view){
    ...
    public void deleteTipe(JIFBarangKecilBonusKaryawanBKView view){
