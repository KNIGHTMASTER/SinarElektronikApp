 ...
 */
package com.wissensalt.sinarelektronik.masterdata.barangkecil.stokreminder.model;
...
public class ReminderModel {
    ...
    public void searchBarangbyStokMin(String kataKunci) throws SQLException, BarangException{
        ReminderDao dao = ReminderDatabase.getReminderDao();
        List<BarangKecilDTO> list =dao.getBarangbyStok_min(kataKunci);
        fireOnSearch(list);
    }
    ...
    public void sortBarangbyStokMin() throws SQLException, BarangException{
        ReminderDao dao = ReminderDatabase.getReminderDao();
        List<BarangKecilDTO> list =dao.sortBarangbyStok_min();
        fireOnSort(list);
    }
