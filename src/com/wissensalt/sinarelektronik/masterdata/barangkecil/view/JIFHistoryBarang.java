 ...
 * @author Fauzi
 */
public class JIFHistoryBarang extends javax.swing.JInternalFrame {

    /**
     * Creates new form JIFUpdateGlobalBK
     */
    
    private final String SELECTALLBARANG = "SELECT * FROM baranghistory";    
    
    private String berdasarkan = "";
    
    private final String SORTBARANGBY = "SELECT * FROM baranghistory ORDER BY ";
            
    
    public JIFHistoryBarang() {
        koneksi();
        initComponents();
        loadData();
    }
    ...
    private void loadData(){
        ...
        try{
            ...
            String [] kolom = {"tanggal", "idbarang", "nama", "tipe", "MerekDTO", "modal", "grosir", "eceran", "stok", "supplier", "kategori"};
    ...
    private void initComponents() {
        ...
        cmbKataKunci1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "id barangkecil", "nama barangkecil", "tipe", "MerekDTO", "stok", "supplier", "kategori" }));
        jPanel1.add(cmbKataKunci1);

        cmbKataKunci2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cmbKataKunci2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "id barangkecil", "tanggal", "nama barangkecil", "tipe", "MerekDTO", "stok", "supplier", "kategori" }));
        ...
        cmbCari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "id barangkecil", "tanggal", "nama barangkecil", "tipe", "MerekDTO", "stok", "supplier", "kategori" }));
    ...
    private void cari(){
        ...
        if(kategori2.trim().equals("tanggal")){
            ...
            SEARCHBARANGBY = "SELECT * FROM baranghistory WHERE "+kategori1+" LIKE '%"+kataKunci1+"%' AND (tanggal>='"+tgl1+"' and tanggal<='"+tgl2+"')";
        }else{
            kataKunci1 = txtKataKunci1.getText();
            kataKunci2 = txtKataKunci2.getText();        
            
            SEARCHBARANGBY = "SELECT * FROM baranghistory WHERE "+kategori1+" LIKE '%"+kataKunci1+"%' AND "+kategori2+" LIKE '%"+kataKunci2+"%'";   
        }
