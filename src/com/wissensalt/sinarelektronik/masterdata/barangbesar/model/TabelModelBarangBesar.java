package com.wissensalt.sinarelektronik.masterdata.barangbesar.model;
 ...
 * @author Fauzi
 */
public class TabelModelBarangBesar extends AbstractTableModel{

    private List<BarangBesarDTO> list = new ArrayList<>();

    public void setList(List<BarangBesarDTO> list) {
        this.list = list;
        fireTableDataChanged();
    }

    public boolean add(BarangBesarDTO e) {
        try{
            return list.add(e);
        }finally{
    ...
    public BarangBesarDTO get(int index) {
            return list.get(index);
    }

    public BarangBesarDTO set(int index, BarangBesarDTO element) {
        try{
    ...
    public BarangBesarDTO remove(int index) {
        try{
