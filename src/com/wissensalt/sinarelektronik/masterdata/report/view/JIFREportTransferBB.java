 ...
 * @author Fauzi
 */
public class JIFREportTransferBB extends javax.swing.JInternalFrame {

    /**
     * Creates new form JIFREportTransferBB
     */
    public JIFREportTransferBB() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Laporan Transfer Barang Besar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(txtTanggalAwal.getDate()==null){
            ...
            rp.buildReportDoubleParam("transferbb", txtTanggalAwal.getDate(), txtTanggalAkhir.getDate());
        }
